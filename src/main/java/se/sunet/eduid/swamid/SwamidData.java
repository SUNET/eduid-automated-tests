...
public class SwamidData {
    ...
    private void verifyUserData(boolean confirmedUser){
        ...
        if(confirmedUser) {
            ...
            common.verifyStringByXpath("//*[@id=\"attributes\"]/table[1]/tbody/tr[3]/td", common.getDisplayName());
            common.verifyStringByXpath("//*[@id=\"attributes\"]/table[1]/tbody/tr[4]/td", "Sweden");
            common.verifyStringByXpath("//*[@id=\"attributes\"]/table[1]/tbody/tr[5]/td", common.getDisplayName());
            common.verifyStringByXpath("//*[@id=\"attributes\"]/table[1]/tbody/tr[6]/td", "http://www.swamid.se/policy/assurance/al1");
            common.verifyStringByXpath("//*[@id=\"attributes\"]/table[1]/tbody/tr[7]/td", common.getEppn() +"@dev.eduid.se");
            ...
            common.verifyStringByXpath("//*[@id=\"attributes\"]/table[1]/tbody/tr[9]/td", (common.getEppn() +"@dev.eduid.se").replace("-", ""));
            common.verifyStringByXpath("//*[@id=\"attributes\"]/table[1]/tbody/tr[10]/td", common.getGivenName());
            common.verifyStringByXpath("//*[@id=\"attributes\"]/table[1]/tbody/tr[11]/td", common.getEmail());
            common.verifyStringByXpath("//*[@id=\"attributes\"]/table[1]/tbody/tr[12]/td", common.getSurName());
        }
        else{
            ...
            common.verifyStringByXpath("//*[@id=\"attributes\"]/table[1]/tbody/tr[5]/td", common.getEppn() +"@dev.eduid.se");
            ...
            common.verifyStringByXpath("//*[@id=\"attributes\"]/table[1]/tbody/tr[7]/td", (common.getEppn() +"@dev.eduid.se").replace("-", ""));
            common.verifyStringByXpath("//*[@id=\"attributes\"]/table[1]/tbody/tr[8]/td", common.getEmail());
        }
    }
