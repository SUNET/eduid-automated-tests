...
public class Help {
    ...
    private static final List<String> SECTION_IDS = List.of(
            "help-contact", "help-about-sunet", "help-privacy-accessibility",
            "help-orcid-ladok", "help-tou", "help-verification", "help-international",
            "help-eidas", "help-freja", "help-bankid", "help-security-key",
            "help-assurance-levels", "help-security-usb", "security-key-list",
            "help-using-eduid", "help-relogin", "help-Account", "help-security",
            "help-identity", "help-start", "help-pw", "help-login", "help-create",
            "help-about-eduid"
    );
    ...
    private void useEduIdSwe(String pageBody) {
        ...
        common.verifyPageBodyContainsString(pageBody, "Epostadresser: Du kan lägga till så många du önskar men behöver minst en epostadress som du har bekräftad åtkomst till. Du kan logga in med alla bekräftade adresser men den primära används för att kommunicera med dig. De listas i en tabell med följande alternativ:\nLägg till genom att klicka på länken \"+ lägg till fler\" och ta bort genom att klicka på papperskorgs-ikonen.\nBekräfta en epostadress genom att klicka på länken \"Bekräfta\" och fylla i koden som skickas till den adressen i formuläret.\nGör en epostadress primär genom att klicka på länken \"Gör primär\".");
    ...
    private void securityEduIdEng(String pageBody) {
        ...
        common.verifyPageBodyContainsString(pageBody, "An example of a security key would be a physical device in your possession, such as a specific type of USB token for this purpose, that requires you to be present by the device. You may also add biometric information such as fingerprint or face-recognition supported on the device you are using, to be able to unlock your security key, if needed.");
        common.verifyPageBodyContainsString(pageBody, "How do I implement MFA with eduID?");
        common.verifyPageBodyContainsString(pageBody, "When logged in you can add and confirm security keys of your choice (provided you have access to any of these methods) in the Security area of eduID and follow the instructions.");
        common.verifyPageBodyContainsString(pageBody, "Note: if you have added a security key to your eduID it must be used to log in to eduID, unless you turn off this feature under Manage your security keys in Security. You might still need to use your security key if other connecting services require MFA.");
    ...
    private void contactEduIdEng(String pageBody) {
        ...
        common.verifyPageBodyContainsString(pageBody, "In order to get best possible support, we recommend that you send e-mail, but for simple matters you can also reach us on phone number 08-555 213 62");
