...
public class DashBoard {
    ...
    public void runDashBoard() {
        ...
        // OPTIMERING 1: Validera alla globala länkar EN gång här istället för per språk
        verifyGlobalLinks();
    }
    ...
    // OPTIMERING 1 (forts.): Samlad metod för länkvalidering
    private void verifyGlobalLinks() {
        log.info("Verifying global functional links on Dashboard");
        ...
        // Om TC_1 körs testar vi även länkarna i sidomenyn en gång
    ...
    // OPTIMERING 2: Isolerad metod för menylänkar, körs enbart en gång
    private void verifyMenuLinks() {
        expandMenuSection(NAV_START_CHEVRON, NAV_START_EXPAND);
    ...
    private void expandMenuSection(By locator, By buttonLocator) {
        common.waitUntilClickable(buttonLocator);
