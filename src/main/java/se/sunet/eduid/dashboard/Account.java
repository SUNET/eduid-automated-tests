...
public class Account {
    ...
    private void pressLadok() {
        ...
        // OPTIMERING: Hämta pageBody direkt efter att Ladok expanderats
    ...
    private void pressOrcid() {
        ...
        common.waitUntilClickable(By.id("onetrust-accept-btn-handler")).click();
        common.timeoutSeconds(1);
        common.findWebElement(By.id("username-input")).sendKeys(testData.getUsername());
        common.findWebElement(By.id("password")).sendKeys(testData.getOrcidPassword());

        common.findWebElement(By.id("signin-button")).click();
        common.waitUntilClickable(By.id("remove-orcid-button"));

        String pageBody = common.getPageBody();
        common.verifyPageBodyContainsString(pageBody, "https://sandbox.orcid.org/0009-0000-8272-734X");
        common.waitUntilClickable(By.id("remove-orcid-button")).click();
        common.waitUntilClickable(CONNECT_ORCID_BUTTON);
        log.info("Removed ORCID connection");
    }
    ...
    private void verifyLabels() {
        // OPTIMERING: Hämta pageBody direkt i verifieringsloopen och skicka med den
