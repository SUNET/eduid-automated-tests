...
public class EmailSent {
    ...
    private void verifyLabels(){
        ...
        common.verifyPageBodyContainsString(pageBody, testData.getEmail().toLowerCase() +". från no-reply@eduid.se.");
        ...
        common.verifyPageBodyContainsString(pageBody, testData.getEmail().toLowerCase() +". from no-reply@eduid.se.");
